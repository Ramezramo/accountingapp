  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedIconTheme: IconThemeData(size: 30), // Adjust icon size for selected items
        unselectedIconTheme: IconThemeData(size: 24), // Adjust icon size for unselected items
      ),
    );
  }
}
