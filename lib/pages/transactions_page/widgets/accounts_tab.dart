      ...
      child: DefaultContainer(
        child: Column(
          children: [
            ...
            accounts.when(
              data: (data) {
                List<BankAccountRM> accountIncomeList = data
                    .where((account) =>
                        accountToAmountIncome.containsKey(account.id))
                    .toList();
                List<BankAccountRM> accountExpenseList = data
                    .where((account) =>
                            ...
                            children: [
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  BankAccountRM b = accountIncomeList[index];
                            ...
                            children: [
                              ...
                              ListView.separated(
                                ...
                                separatorBuilder: (context, index) =>
                                    const SizedBox(height: 10),
                                itemBuilder: (context, index) {
                                  BankAccountRM b = accountExpenseList[index];
                                  return AccountListTile(
                                    title: b.name,
                                    nTransactions:
